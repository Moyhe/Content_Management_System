...
if (mysqli_num_rows($result) > 0) {
   ...
   ?>   
   <li class="nav-item">
     <a class="nav-link" aria-current="page" href="manageContent.php?menu=<?php echo mysqli_real_escape_string($conn, $row['id']);?>"> <h4><?php echo mysqli_real_escape_string($conn, $row['item_name']);?></h4></a>
  </li>
